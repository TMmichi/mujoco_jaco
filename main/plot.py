...
# axes[1].plot(df['Step'], df['Pick-Reaching'], color='dodgerblue', linestyle='-',linewidth=1, label='Pick-Reaching')
# axes[1].plot(df['Step'], df['Pick-Grasping'], color='yellowgreen', linestyle='-', linewidth=1, label='Pick-Grasping')
# axes[1].plot(df['Step'], df['Place-Reaching'], color='yellow', linestyle='-', linewidth=1, label='Place-Reaching')
# axes[1].plot(df['Step'], df['Place-Releasing'], color='aqua', linestyle='-', linewidth=1, label='Place-Releasing')
...
# plt.plot(df['Step'], df['Reaching'], color='dodgerblue', linewidth=1, label='Reaching')
# plt.plot(df['Step'], df['Grasping'], color='yellowgreen', linewidth=1, label='Grasping')
